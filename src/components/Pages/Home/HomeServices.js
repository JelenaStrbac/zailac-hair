              ...
              <div className={styles.container}>
                ...
                <div className={styles.overlay}>
                  <div className={styles.text}>
                    ...
                    sede ili da drastično promenite boju svoje kose, tu smo za
                    sve eksperimente za koje ste spremne.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={styles.servicesGalleryContentImagesRight}>
            ...
            <div className={styles.servicesGalleryContentImg}>
              <div className={styles.container}>
                ...
                <div className={styles.overlay}>
                  <div className={styles.text}>
                    Zdrava, negovana, lepo ošišana, perfektno obojena, lepršava
                    i živahna su reči kojima se može opisati Vaša kosa nakon ove

...
module.exports = {
  siteMetadata: {
    ...
    description: `Dobrodošli u Zailac Hair - frizerski salon u Beogradu koji se bavi koloringom i nadogradnjom kose. Savršen tretman vaše kose upotrebom profesionalnih preparata.`,
    author: `@MladenZailac`,
    keywords: [
      `frizer`,
      `salon`,
